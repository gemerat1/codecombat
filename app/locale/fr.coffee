module.exports = nativeDescription: "français", englishDescription: "French", translation:
  home:
    slogan: "Apprenez à coder tout en jouant" # slogan: "The most engaging game for learning programming."
    classroom_edition: "Edition pour une classe d'école:" # classroom_edition: "Classroom Edition:"
    learn_to_code: "Apprenez à coder:" # learn_to_code: "Learn to code:"
    teacher: "Professeur" # teacher: "Teacher"
    student: "Elève" # student: "Student"
    play_now: "Jouer Maintenant" # play_now: "Play Now"
    im_a_teacher: "Je suis un Enseignant" # im_a_teacher: "I'm a Teacher"
    im_a_student: "Je suis un Elève" # im_a_student: "I'm a Student"
    learn_more: "Apprendre plus" # learn_more: "Learn more"
    classroom_in_a_box: "Un kit pour la classe pour enseigner l'informatique." # classroom_in_a_box: "A classroom in-a-box for teaching computer science."
    codecombat_is: "CodeCombat est une plate-forme <strong>pour les élèves</strong> pour apprendre l'informatique en jouant à un vrai jeu." # codecombat_is: "CodeCombat is a platform <strong>for students</strong> to learn computer science while playing through a real game."
    our_courses: "Nos formations ont été spécialement testées pour <strong>réussir en classe</strong>, même pour des professeurs avec une petite ou même aucune expérience en informatique." # our_courses: "Our courses have been specifically playtested to <strong>excel in the classroom</strong>, even by teachers with little to no prior programming experience."
    top_screenshots_hint: "Les élèves écrivent du code et voient leurs changements en temps réel" # top_screenshots_hint: "Students write code and see their changes update in real-time"
    designed_with: "Conçu en pensant aux enseignats" # designed_with: "Designed with teachers in mind"
    real_code: "Du vrai code, saisi au clavier" # real_code: "Real, typed code"
    from_the_first_level: "dès le premier niveau" # from_the_first_level: "from the first level"
    getting_students: "Faire en sorte que les élèves saisissent du code aussitôt que possible et aussi rapidement que possible est essentiel pour apprendre à respecter la syntaxe et la structure des programmes". # getting_students: "Getting students to typed code as quickly as possible is critical to learning programming syntax and proper structure."
    educator_resources: "Ressources pour les enseignants" # educator_resources: "Educator resources"
    course_guides: "et guides pour les cours" # course_guides: "and course guides"
    teaching_computer_science: "Enseigner l'informatique ne requiert pas un diplôme coûteux, parce que nous fournissons des outils pour soutenir les enseignants de tous horizons." # teaching_computer_science: "Teaching computer science does not require a costly degree, because we provide tools to support educators of all backgrounds."
    accessible_to: "Accessible à" # accessible_to: "Accessible to"
    everyone: "tout le monde" # everyone: "everyone"
    democratizing: "Démocratiser le processus d'enseignement de la programmation est au coeur de notre philosophie. Chaque personne devrait pouvoir apprendre à programmer." # democratizing: "Democratizing the process of learning coding is at the core of our philosophy. Everyone should be able to learn to code."
    forgot_learning: "Je crois qu'en fait ils ont oublié qu'ils étaient en réalité en train d'apprendre quelque chose." # forgot_learning: "I think they actually forgot that they were actually learning something."
    wanted_to_do: "Programmer est quelque chose que j'ai toujours eu envie de faire, et je n'ai jamais pensé que je pourrais l'apprendre à l'école." # wanted_to_do: " Coding is something I've always wanted to do, and I never thought I would be able to learn it in school."
    why_games: "Pourquoi est-il important d'apprendre en jouant ?" # why_games: "Why is learning through games important?"
    games_reward: "Les jeux récompensent les efforts productifs." # games_reward: "Games reward the productive struggle."
    encourage: "Le jeu est un médium qui encourage l'interaction, la découverte et les essais et l'acceptation des erreurs. Un bon jeu met le joueur au défi de maîtriser des compétences avec le temps, ce qui est le même processus critique par lequel les élèves passent lorsqu'ils apprennent." # encourage: "Gaming is a medium that encourages interaction, discovery, and trial-and-error. A good game challenges the player to master skills over time, which is the same critical process students go through as they learn."
    excel: "Les jeux savent très bien récompenser" # excel: "Games excel at rewarding"
    struggle: "un effort productif" # struggle: "productive struggle"
    kind_of_struggle: "le genre d'effort qui se transforme en un apprentissage engageant et" # kind_of_struggle: "the kind of struggle that results in learning that’s engaging and"
    motivating: "motivant" # motivating: "motivating"
    not_tedious: "pas ennuyant." # not_tedious: "not tedious."
    gaming_is_good: "Des études suggérent que le jeu est bon pour le cerveau de l'enfant. (C'est vrai!)" # gaming_is_good: "Studies suggest gaming is good for children’s brains. (it’s true!)"
